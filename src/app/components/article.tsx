    ...
    return (
        <>
            <div className="flex-col-reverse md:flex-row flex">
                <div className="py-32 md:px-36 md:basis-1/2 text-center md:text-start">
            ...
            <div className="flex-col md:flex-row flex">
                ...
                <div className="py-32 md:px-20 md:basis-1/2 text-center md:text-start">
            ...
            <div className="flex-col  md:flex-row flex w-full ">
                <div className="gBack md:basis-1/2">
                    ...
                    <p className="font-Barlow text-Dark-desaturated-cyan mt-5 text-center w-fit mx-5 md:mx-0"> Great design makes you memorable. We deliver artwork that underscores your brand message and 
                ...
                <div className="oBack md:basis-1/2">
                    ...
                    <p className="font-Barlow text-Dark-desaturated-cyan mt-5 text-center mx-5 md:mx-0">Increase your credibility by getting the most stunning, high-quality photos that 
