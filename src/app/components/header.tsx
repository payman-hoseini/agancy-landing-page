    ...
    return (
        <div className="background w-full h-full ">
            <div className="flex justify-between items-center pt-6 px-8">
              ...
              <button onClick={showMenuHandler} className="md:hidden">
            ...
            {!showMenu && <div className="grid place-content-center place-items-center w-full mt-24">
              <p className="font-Fraunces text-white md:text-7xl text-[45px]/[50px] text-center tracking-widest font-extrabold">WE ARE CREATIVES</p>
            ...
            {showMenu && <div className="bg-white mx-8 py-9 relative mt-10">
              <ul className="text-center space-y-5">
                <li className="font-Barlow text-Very-dark-grayish-blue text-lg">About</li>
                <li className="font-Barlow text-Very-dark-grayish-blue text-lg">Services</li>
                <li className="font-Barlow text-Very-dark-grayish-blue text-lg">Projects</li>
                <button className="bg-Yellow px-5 py-3 rounded-full font-Fraunces text-Very-dark-desaturated-blue">CONTACT</button>
              </ul>
              <div className="border-t-[60px] border-t-transparent border-r-[60px] border-r-white border-b-[60px] border-b-transparent absolute -top-6 right-0 "></div>
            </div>}
        </div>
    )
}